...
当前实际学习进度和每章验证证据以 [PROGRESS.md](PROGRESS.md) 为准；截至 2026-08-24，工程实现已推进到第 16 章，正式讲解已完成第 1～7 章和第 10 章，第 8～9 章及第 11～16 章待正式讲解。
...
第 5～16 章统一采用“概念层 → 最小实践层 → 工程实现层”。课程材料已经包含三层的目标和验收标准；第 11～16 章的工程层已生成并验证。
