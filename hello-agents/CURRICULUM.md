...
当前实际学习进度和每章验证证据以 [PROGRESS.md](PROGRESS.md) 为准；截至 2026-08-24 已完成第 1～7 章本轮学习。
...
第 5～16 章统一采用“概念层 → 最小实践层 → 工程实现层”。课程材料已经包含三层的目标和验收标准；当前项目代码中部分章节只有前两层，工程层会在逐课学习时继续实现。
